import { Body, Controller, Get, Patch, Post, Query, Req, Res, UseFilters, UseInterceptors, Version } from '@nestjs/common';
...
export class AdminController {
  ...
  async adminLoginV2(
    ...
    const adminLoginResponse = await this.adminService.AdminLoginV2(body, request.metaData!);
    if(useCookie){
